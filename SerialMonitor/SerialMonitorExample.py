...
class SerialMonitorExample(QtCore.QObject):

    

    def __init__(self, parent=None):

        super(SerialMonitorExample, self).__init__(parent)
        ...
        #  by using a timer to call ApplicationSetup. This ensures that the
        #  application event loop is running when ApplicationSetup is called.
        startTimer = QtCore.QTimer(self)
        startTimer.timeout.connect(self.ApplicationSetup)
